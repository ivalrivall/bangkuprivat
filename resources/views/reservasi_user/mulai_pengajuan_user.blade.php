            ...
            <form class="form-horizontal" action="{{ url('/user/pengajuan/reservasi') }}" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-12" style="margin-bottom:3%;">
                  ...
                  <textarea id="spek_kebutuhan" class="col-md-12 form-control" name="spek_kebutuhan" maxlength="200"
                    style="height:100%;"
                ...
                <div class="col-md-12" style="margin-bottom:1%;">
                  ...
                  <div class="row col-md-10">
                    <div class="col-md-2">
                      ...
                      <div>
                        <input type="checkbox" class="mr-2" name="hari_dibutuhkan[]" value="{{ $val->id }}">
                        {{ $val->hari->hari }}
                      </div>
                    </div>
                    <div class="col-md-10">
                      <div class="row">
                        ...
                        <div class="col-7">
                          ...
                          <div class="d-flex">
                            <input type="time" class="form-control" style="width:100px" value="{{ $val->start_jam }}"
                              readonly>
                            &nbsp;<label> sampai </label>&nbsp;
                            <input type="time" class="form-control" style="width:100px" value="{{ $val->end_jam }}"
                              readonly>
                          </div>
                        </div>
                        <div class="col-4">
                ...
                <div class="col-md-12" style="margin-bottom:1%;">
                  ...
                  <input type="radio" class="ml-3" name="tipe_pengajaran" value="{{ $val->tipe_pengajaran_id }}">
